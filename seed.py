...
from app import init_db, get_standalone_connection, auto_summary, SIMILARITY_FLAG_THRESHOLD
...
def seed():
    ...
    for title, thread in SAMPLE_DISCUSSION.items():
        ...
        for question, answer in thread:
            ...
            q_cur = db.execute(
                "INSERT INTO comments (project_id, user_id, parent_id, body, created_at) VALUES (?, ?, NULL, ?, ?) RETURNING id",
